...
class MotusGUI:
    def __init__(self, root):
        ...
        # 1. Mode API ou Local ?
        self.use_api = messagebox.askyesno("Mode de jeu", "Voulez-vous jouer avec l'API en ligne (tous les mots français) ?")
        ...
        try:
            self.jeu = MotusEngine(dictionnaire_path=chemin_dico, longueur=self.longueur, use_api=self.use_api)
    ...
    def creer_interface(self):
        ...
        header.pack(fill="x")
        tk.Label(header, text="MOTUS ELITE", fg="white", bg="#1a73e8", font=("Segoe UI", 24, "bold")).pack(pady=10)
